...
const getHandTypeName = type => {
	if (type === FIVE_OF_A_KIND) return "FIVE_OF_A_KIND";
	if (type === FOUR_OF_A_KIND) return "FOUR_OF_A_KIND";
	if (type === FULL_HOUSE) return "FULL_HOUSE";
	if (type === THREE_OF_A_KIND) return "THREE_OF_A_KIND";
	if (type === TWO_PAIR) return "TWO_PAIR";
	if (type === ONE_PAIR) return "ONE_PAIR";
	if (type === HIGH_CARD) return "HIGH_CARD";
};
